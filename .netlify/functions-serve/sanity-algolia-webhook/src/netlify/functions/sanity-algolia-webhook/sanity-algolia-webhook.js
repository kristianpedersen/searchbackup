...
var require_logger_common_cjs = __commonJS({
  "node_modules/@algolia/logger-common/dist/logger-common.cjs.js"(exports) {
    "use strict";
    ...
    exports.LogLevelEnum = LogLevelEnum2;
    exports.createNullLogger = createNullLogger;
  }
});

// node_modules/@algolia/logger-common/index.js
var require_logger_common = __commonJS({
  "node_modules/@algolia/logger-common/index.js"(exports, module2) {
    module2.exports = require_logger_common_cjs();
  }
});

// node_modules/@algolia/logger-console/dist/logger-console.cjs.js
var require_logger_console_cjs = __commonJS({
  "node_modules/@algolia/logger-console/dist/logger-console.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var loggerCommon = require_logger_common();
    function createConsoleLogger2(logLevel) {
      return {
        debug(message, args) {
    ...
    exports.createConsoleLogger = createConsoleLogger2;
  }
});

// node_modules/@algolia/logger-console/index.js
var require_logger_console = __commonJS({
  "node_modules/@algolia/logger-console/index.js"(exports, module2) {
    module2.exports = require_logger_console_cjs();
  }
});

// node_modules/@algolia/cache-common/dist/cache-common.cjs.js
var require_cache_common_cjs = __commonJS({
  "node_modules/@algolia/cache-common/dist/cache-common.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_cache_common = __commonJS({
  "node_modules/@algolia/cache-common/index.js"(exports, module2) {
    module2.exports = require_cache_common_cjs();
  }
});

// node_modules/@algolia/cache-in-memory/dist/cache-in-memory.cjs.js
var require_cache_in_memory_cjs = __commonJS({
  "node_modules/@algolia/cache-in-memory/dist/cache-in-memory.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_cache_in_memory = __commonJS({
  "node_modules/@algolia/cache-in-memory/index.js"(exports, module2) {
    module2.exports = require_cache_in_memory_cjs();
  }
});

// node_modules/@algolia/client-common/dist/client-common.cjs.js
var require_client_common_cjs = __commonJS({
  "node_modules/@algolia/client-common/dist/client-common.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function encode(format, ...args) {
      let i2 = 0;
      return format.replace(/%s/g, () => encodeURIComponent(args[i2++]));
    }
    var version = "4.14.2";
    var destroy = (base) => {
      return () => {
...
var require_client_common = __commonJS({
  "node_modules/@algolia/client-common/index.js"(exports, module2) {
    module2.exports = require_client_common_cjs();
  }
});

// node_modules/@algolia/requester-common/dist/requester-common.cjs.js
var require_requester_common_cjs = __commonJS({
  "node_modules/@algolia/requester-common/dist/requester-common.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var MethodEnum = {
      Delete: "DELETE",
...
var require_requester_common = __commonJS({
  "node_modules/@algolia/requester-common/index.js"(exports, module2) {
    module2.exports = require_requester_common_cjs();
  }
});

// node_modules/@algolia/transporter/dist/transporter.cjs.js
var require_transporter_cjs = __commonJS({
  "node_modules/@algolia/transporter/dist/transporter.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var requesterCommon = require_requester_common();
    ...
    function retryableRequest(transporter, statelessHosts, request, requestOptions) {
      ...
      const dataQueryParameters = request.method !== requesterCommon.MethodEnum.Get ? {} : __spreadValues(__spreadValues({}, request.data), requestOptions.data);
    ...
    function deserializeSuccess(response) {
      try {
        ...
        throw createDeserializationError(e2.message, response);
      }
    }
    ...
    function serializeData(request, requestOptions) {
      if (request.method === requesterCommon.MethodEnum.Get || request.data === void 0 && requestOptions.data === void 0) {
        return void 0;
      }
...
var require_transporter = __commonJS({
  "node_modules/@algolia/transporter/index.js"(exports, module2) {
    module2.exports = require_transporter_cjs();
  }
});

// node_modules/@algolia/client-analytics/dist/client-analytics.cjs.js
var require_client_analytics_cjs = __commonJS({
  "node_modules/@algolia/client-analytics/dist/client-analytics.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var clientCommon = require_client_common();
    var transporter = require_transporter();
    var requesterCommon = require_requester_common();
    var createAnalyticsClient = (options) => {
      const region = options.region || "us";
      const auth = clientCommon.createAuth(clientCommon.AuthMode.WithinHeaders, options.appId, options.apiKey);
      const transporter$1 = transporter.createTransporter(__spreadProps(__spreadValues({
        hosts: [{ url: `analytics.${region}.algolia.com` }]
      }, options), {
        headers: __spreadValues(__spreadValues(__spreadValues({}, auth.headers()), { "content-type": "application/json" }), options.headers),
...
// node_modules/@algolia/client-analytics/index.js
var require_client_analytics = __commonJS({
  "node_modules/@algolia/client-analytics/index.js"(exports, module2) {
    module2.exports = require_client_analytics_cjs();
  }
});

// node_modules/@algolia/client-personalization/dist/client-personalization.cjs.js
var require_client_personalization_cjs = __commonJS({
  "node_modules/@algolia/client-personalization/dist/client-personalization.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var clientCommon = require_client_common();
    var transporter = require_transporter();
    var requesterCommon = require_requester_common();
    var createPersonalizationClient = (options) => {
      const region = options.region || "us";
      const auth = clientCommon.createAuth(clientCommon.AuthMode.WithinHeaders, options.appId, options.apiKey);
      const transporter$1 = transporter.createTransporter(__spreadProps(__spreadValues({
    ...
    var getPersonalizationStrategy = (base) => {
      return (requestOptions) => {
        return base.transporter.read({
          method: requesterCommon.MethodEnum.Get,
    ...
    var setPersonalizationStrategy = (base) => {
...
var require_client_personalization = __commonJS({
  "node_modules/@algolia/client-personalization/index.js"(exports, module2) {
    module2.exports = require_client_personalization_cjs();
  }
});

// node_modules/@algolia/client-search/dist/client-search.cjs.js
var require_client_search_cjs = __commonJS({
  "node_modules/@algolia/client-search/dist/client-search.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var clientCommon = require_client_common();
    var transporter = require_transporter();
    ...
    var addApiKey = (base) => {
      return (acl, requestOptions) => {
        const _a = requestOptions || {}, { queryParameters } = _a, options = __objRest(_a, ["queryParameters"]);
    ...
    var clearDictionaryEntries = (base) => {
    ...
    var copyRules = (base) => {
      return (from, to, requestOptions) => {
        return copyIndex(base)(from, to, __spreadProps(__spreadValues({}, requestOptions), {
          scope: [ScopeEnum.Rules]
        }));
      };
    };
    var copySettings = (base) => {
      return (from, to, requestOptions) => {
        return copyIndex(base)(from, to, __spreadProps(__spreadValues({}, requestOptions), {
    ...
    var deleteDictionaryEntries = (base) => {
    ...
    var getDictionarySettings = (base) => {
      return (requestOptions) => {
        return base.transporter.read({
          method: requesterCommon.MethodEnum.Get,
    ...
    var getSecuredApiKeyRemainingValidity = () => {
      return (securedApiKey) => {
        ...
        return parseInt(match[1], 10) - Math.round(new Date().getTime() / 1e3);
      };
    };
    var getTopUserIDs = (base) => {
      return (requestOptions) => {
        return base.transporter.read({
          method: requesterCommon.MethodEnum.Get,
    ...
    var hasPendingMappings = (base) => {
      return (requestOptions) => {
        const _a = requestOptions || {}, { retrieveMappings } = _a, options = __objRest(_a, ["retrieveMappings"]);
    ...
    var replaceDictionaryEntries = (base) => {
    ...
    var saveDictionaryEntries = (base) => {
      return (dictionary, entries, requestOptions) => {
        const requests = entries.map((entry) => ({
          action: "addEntry",
          body: entry
    ...
    var searchDictionaryEntries = (base) => {
    ...
    var setDictionarySettings = (base) => {
    ...
    var browseObjects = (base) => {
      return (requestOptions) => {
        return createBrowsablePromise(__spreadProps(__spreadValues({
    ...
    var browseRules = (base) => {
      return (requestOptions) => {
        ...
        return createBrowsablePromise(__spreadProps(__spreadValues({
          ...
          request(data) {
            return searchRules(base)("", __spreadValues(__spreadValues({}, options), data)).then((response) => {
    ...
    var browseSynonyms = (base) => {
      return (requestOptions) => {
        ...
        return createBrowsablePromise(__spreadProps(__spreadValues({
          ...
          request(data) {
            return searchSynonyms(base)("", __spreadValues(__spreadValues({}, options), data)).then((response) => {
              return __spreadProps(__spreadValues({}, response), {
    ...
    var chunkedBatch = (base) => {
      return (bodies, action, requestOptions) => {
        const _a = requestOptions || {}, { batchSize } = _a, options = __objRest(_a, ["batchSize"]);
        const response = {
          taskIDs: [],
          objectIDs: []
        };
    ...
    var clearRules = (base) => {
      return (requestOptions) => {
        const _a = requestOptions || {}, { forwardToReplicas } = _a, options = __objRest(_a, ["forwardToReplicas"]);
    ...
    var findObject = (base) => {
      return (callback, requestOptions) => {
        const _a = requestOptions || {}, { query, paginate } = _a, options = __objRest(_a, ["query", "paginate"]);
        let page = 0;
        const forEachPage = () => {
          return search(base)(query || "", __spreadProps(__spreadValues({}, options), { page })).then((result) => {
    ...
    var getObjects = (base) => {
      return (objectIDs, requestOptions) => {
        const _a = requestOptions || {}, { attributesToRetrieve } = _a, options = __objRest(_a, ["attributesToRetrieve"]);
        const requests = objectIDs.map((objectID) => {
    ...
    var partialUpdateObjects = (base) => {
      return (objects, requestOptions) => {
        const _a = requestOptions || {}, { createIfNotExists } = _a, options = __objRest(_a, ["createIfNotExists"]);
        const action = createIfNotExists ? BatchActionEnum.PartialUpdateObject : BatchActionEnum.PartialUpdateObjectNoCreate;
        return chunkedBatch(base)(objects, action, options);
      };
    };
    var replaceAllObjects = (base) => {
      return (objects, requestOptions) => {
        const _a = requestOptions || {}, { safe, autoGenerateObjectIDIfNotExist, batchSize } = _a, options = __objRest(_a, ["safe", "autoGenerateObjectIDIfNotExist", "batchSize"]);
        ...
        let responses = [];
        const copyWaitablePromise = operation(base.indexName, temporaryIndexName, "copy", __spreadProps(__spreadValues({}, options), {
          scope: ["settings", "synonyms", "rules"]
        }));
        responses.push(copyWaitablePromise);
        const result = (safe ? copyWaitablePromise.wait(options) : copyWaitablePromise).then(() => {
          const saveObjectsWaitablePromise = saveObjectsInTemporary(objects, __spreadProps(__spreadValues({}, options), {
    ...
    var replaceAllRules = (base) => {
      return (rules, requestOptions) => {
        return saveRules(base)(rules, __spreadProps(__spreadValues({}, requestOptions), {
          clearExistingRules: true
        }));
      };
    };
    var replaceAllSynonyms = (base) => {
      return (synonyms, requestOptions) => {
        return saveSynonyms(base)(synonyms, __spreadProps(__spreadValues({}, requestOptions), {
    ...
    var saveObjects = (base) => {
      return (objects, requestOptions) => {
        const _a = requestOptions || {}, { autoGenerateObjectIDIfNotExist } = _a, options = __objRest(_a, ["autoGenerateObjectIDIfNotExist"]);
    ...
    var saveRules = (base) => {
      return (rules, requestOptions) => {
        const _a = requestOptions || {}, { forwardToReplicas, clearExistingRules } = _a, options = __objRest(_a, ["forwardToReplicas", "clearExistingRules"]);
        const mappedRequestOptions = transporter.createMappedRequestOptions(options);
        if (forwardToReplicas) {
          mappedRequestOptions.queryParameters.forwardToReplicas = 1;
        }
    ...
    var saveSynonym = (base) => {
      return (synonym, requestOptions) => {
        return saveSynonyms(base)([synonym], requestOptions);
      };
    };
    var saveSynonyms = (base) => {
      return (synonyms, requestOptions) => {
        const _a = requestOptions || {}, { forwardToReplicas, clearExistingSynonyms, replaceExistingSynonyms } = _a, options = __objRest(_a, ["forwardToReplicas", "clearExistingSynonyms", "replaceExistingSynonyms"]);
        const mappedRequestOptions = transporter.createMappedRequestOptions(options);
        if (forwardToReplicas) {
          mappedRequestOptions.queryParameters.forwardToReplicas = 1;
        }
...
var require_client_search = __commonJS({
  "node_modules/@algolia/client-search/index.js"(exports, module2) {
    module2.exports = require_client_search_cjs();
  }
});

// node_modules/@algolia/requester-node-http/dist/requester-node-http.cjs.js
var require_requester_node_http_cjs = __commonJS({
  "node_modules/@algolia/requester-node-http/dist/requester-node-http.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var defaultHttpAgent = new http3.Agent(agentOptions);
    var defaultHttpsAgent = new https2.Agent(agentOptions);
    function createNodeHttpRequester({ agent: userGlobalAgent, httpAgent: userHttpAgent, httpsAgent: userHttpsAgent, requesterOptions = {} } = {}) {
      ...
      return {
        send(request) {
          return new Promise((resolve) => {
            const url = URL2.parse(request.url);
            const path = url.query === null ? url.pathname : `${url.pathname}?${url.query}`;
            const options = __spreadValues(__spreadProps(__spreadValues({}, requesterOptions), {
              agent: url.protocol === "https:" ? httpsAgent : httpAgent,
              hostname: url.hostname,
              path,
              method: request.method,
              headers: __spreadValues(__spreadValues({}, requesterOptions && requesterOptions.headers ? requesterOptions.headers : {}), request.headers)
            }), url.port !== void 0 ? { port: url.port || "" } : {});
            const req = (url.protocol === "https:" ? https2 : http3).request(options, (response) => {
              let contentBuffers = [];
...
// node_modules/@algolia/requester-node-http/index.js
var require_requester_node_http = __commonJS({
  "node_modules/@algolia/requester-node-http/index.js"(exports, module2) {
    module2.exports = require_requester_node_http_cjs();
  }
});

// node_modules/algoliasearch/dist/algoliasearch.cjs.js
var require_algoliasearch_cjs = __commonJS({
  "node_modules/algoliasearch/dist/algoliasearch.cjs.js"(exports, module2) {
    "use strict";
    var cacheCommon = require_cache_common();
    var cacheInMemory = require_cache_in_memory();
    var clientAnalytics = require_client_analytics();
    var clientCommon = require_client_common();
    var clientPersonalization = require_client_personalization();
    var clientSearch = require_client_search();
    var loggerCommon = require_logger_common();
    var requesterNodeHttp = require_requester_node_http();
    var transporter = require_transporter();
    function algoliasearch2(appId, apiKey, options) {
      ...
      const searchClientOptions = __spreadValues(__spreadValues({}, commonOptions), options);
      const initPersonalization = () => (clientOptions) => {
        return clientPersonalization.createPersonalizationClient(__spreadProps(__spreadValues(__spreadValues({}, commonOptions), clientOptions), {
          methods: {
      ...
      return clientSearch.createSearchClient(__spreadProps(__spreadValues({}, searchClientOptions), {
        methods: {
          ...
          initAnalytics: () => (clientOptions) => {
            return clientAnalytics.createAnalyticsClient(__spreadProps(__spreadValues(__spreadValues({}, commonOptions), clientOptions), {
              methods: {
    ...
    module2.exports = algoliasearch2;
  }
});

// node_modules/algoliasearch/index.js
var require_algoliasearch = __commonJS({
  "node_modules/algoliasearch/index.js"(exports, module2) {
    var algoliasearch2 = require_algoliasearch_cjs();
    module2.exports = algoliasearch2;
    module2.exports.default = algoliasearch2;
  }
});
...
// netlify/functions/sanity-algolia-webhook/sanity-algolia-webhook.js
var sanity_algolia_webhook_exports = {};
__export(sanity_algolia_webhook_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(sanity_algolia_webhook_exports);
var import_logger_common = __toESM(require_logger_common(), 1);
var import_logger_console = __toESM(require_logger_console(), 1);
var import_algoliasearch = __toESM(require_algoliasearch(), 1);
...
// netlify/functions/sanity-algolia-webhook/sanity-algolia-webhook.js
var AlgoliaProjectID = "C26QC41PWH";
var AlgoliaApiKey = "e23b64dadd4c26f8678c15a2593521fa";
var client = (0, import_algoliasearch.default)(AlgoliaProjectID, AlgoliaApiKey, {
  logger: (0, import_logger_console.createConsoleLogger)(import_logger_common.LogLevelEnum.Debug)
});
var sanityProjectID = "sukats6f";
var index = client.initIndex("Sanity-Algolia");
var handler = async (event) => {
  ...
  try {
    ...
    if (deleted[0]) {
      ...
      const fetchedDataFromSanity = (_a = data == null ? void 0 : data.result[0]) == null ? void 0 : _a.content[0];
      await index.saveObject(__spreadProps(__spreadValues({}, fetchedDataFromSanity), {
...
//# sourceMappingURL=sanity-algolia-webhook.js.map
